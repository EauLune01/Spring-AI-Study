 ...
 * LLM의 최종 출력 예시
 * [
 *   {"title":"서울 여행 브이로그","uploadDate":"2024-12-01","link":"https://youtube.com/..."},
 *   {"title":"서울 필수 관광지 TOP10","uploadDate":"2024-11-15","link":"https://youtube.com/..."}
 * ]
 * */
...
public class Exam08YoutubeSearchAgent {
  ...
  //-----------------------------------------------------------------------------------
  // SerpApi API롤 호출해 여행 관련 비디오 정보를 검색하는 Tool
