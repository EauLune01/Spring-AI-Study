...
public class Exam05AttractionAgent {
   ...
   *
   * // ✅ List는 무조건 이렇게 ParameterizedTypeReference를 사용해야 함
   * // 이 방식이 고수준의 BeanOutputConverter을 사용하는 것
  ...
  //-----------------------------------------------------------------------------------
  //키워드 기반 관광지를 검색하고, 각 후보에 대한 제목, 링크, 요약과 같은 기본 정보를 수집
  ...
  //특정 관광지에 대해 보다 자세한 정보가 필요한 경우 사용
  //-----------------------------------------------------------------------------------
